...
function cargarHeader(arregloJuegos) {
    ...
    header.innerHTML = '<nav><div class="espacioLogo"> <a href="index.html" class="anchorLogo" id="seleccionado"><h1>NOMBRE EMPRESA</h1> </a></div> <div class="espacioLinks"> <a href=""> COMPRA MONEDAS </a><div class="divJuegosHeader"><a href="/html/juegos.html">JUEGOS</a><ul class="dropdown"></ul></div><a href="">FAQ</a><a href="">COTIZACION</a></div></nav>';
